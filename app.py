...
APP_CONFIG = {
    ...
    "CUSTOM_TABS": ["🛠 تعديل وإدارة البيانات"],
...
# تبويب تعديل البيانات فقط
if permissions["can_edit"]:
    tabs = st.tabs(["🛠 تعديل وإدارة البيانات"])
    
    with tabs[0]:
        st.header("🛠 تعديل وإدارة البيانات")
        sheets_edit = manage_data_edit(sheets_edit)
else:
    st.warning("⚠ ليس لديك صلاحية لتعديل البيانات. يرجى التواصل مع المشرف.")import streamlit as st
import pandas as pd
import json
import os
import io
