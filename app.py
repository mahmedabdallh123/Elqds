...
# -------------------------------
# 🖥 دالة البحث المتقدم في الأحداث والكوريكشن فقط
# -------------------------------
...
# وفي قسم التبويبات الرئيسية تم تغيير استدعاء الدالة:
with tabs[2]:  # تبويب "🔍 بحث متقدم"
    advanced_search_events_only(all_sheets)  # بدلاً من advanced_search(all_sheets)
